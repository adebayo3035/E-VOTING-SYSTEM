...
Public Class PRESIDENT_VOTE
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If ComboBox1.SelectedItem = "AFOLABI AYODEJI A.K.A GBOSS" Then
            Dim ans As String
            ans = MsgBox("You've selected to vote for " & ComboBox1.SelectedItem & " Do you want to Continue? ", vbYesNo)

            If ans = vbYes Then
            Dim da As New OleDb.OleDbDataAdapter("SELECT * FROM [candidates]  WHERE [matric]='" & "206320" & "' ", cn)
        ...
        ElseIf ComboBox1.SelectedItem = "ASENUGA ADEOLU A.K.A DEOLU" Then
            Dim ans As String
            ans = MsgBox("You've selected to vote for " & ComboBox1.SelectedItem & " Do you want to Continue? ", vbYesNo)

            If ans = vbYes Then
                Dim da As New OleDb.OleDbDataAdapter("SELECT * FROM [candidates]  WHERE [matric]='" & "206321" & "' ", cn)
                Dim dt As New DataTable
                da.Fill(dt)
        ...
        ElseIf ComboBox1.SelectedItem = "ALOLA DAVID A.K.A ALOLA" Then
            Dim ans As String
            ans = MsgBox("You've selected to vote for " & ComboBox1.SelectedItem & " Do you want to Continue? ", vbYesNo)

            If ans = vbYes Then
                Dim da As New OleDb.OleDbDataAdapter("SELECT * FROM [candidates]  WHERE [matric]='" & "206322" & "' ", cn)
                Dim dt As New DataTable
                da.Fill(dt)
        ...
        ElseIf ComboBox1.SelectedItem = "AFUWAPE ADEFEMI A.K.A FM" Then
            Dim ans As String
            ans = MsgBox("You've selected to vote for " & ComboBox1.SelectedItem & " Do you want to Continue? ", vbYesNo)

            If ans = vbYes Then
                Dim da As New OleDb.OleDbDataAdapter("SELECT * FROM [candidates]  WHERE [matric]='" & "206323" & "' ", cn)
                Dim dt As New DataTable
                da.Fill(dt)
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        cn.Open()
        Dim Cmd As New OleDb.OleDbCommand("INSERT INTO president VALUES('" & Label15.Text & "','" & Label16.Text & "', '" & datetimepicker1.value & "')", cn)
        Cmd.ExecuteNonQuery()
        Cmd.Dispose()
        MsgBox("Successfully Voted for " + Label16.Text + " As Nacoss President")
        Call reset()
    ...
    Private Sub me_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        MsgBox("You have to finish casting your vote and allow application to stop automatically", MsgBoxStyle.Exclamation)
        Me.Show()
    End Sub
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        If ComboBox1.SelectedItem = "AFOLABI AYODEJI A.K.A GBOSS" Then
            ...
            myconnection.Open()
            co = "update president set [candidate_name] = '" & Label16.Text & "' where matric= '" & Label15.Text & "'"
    ...
    Sub PRESIDENTVOTE()
        ...
        If dt.Rows.Count > 0 Then
            ...
            VOTE_PREVIEW.PictureBox1.Image = Me.PictureBox1.Image
        End If
