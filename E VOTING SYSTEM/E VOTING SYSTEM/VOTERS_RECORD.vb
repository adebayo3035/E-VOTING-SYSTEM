...
Imports System.IO
Public Class VOTERS_RECORD

    Private Sub VOTERS_RECORD_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        ds = New DataSet
        tables = ds.Tables
        da = New OleDbDataAdapter("SELECT  matric,firstname,lastname,my_level,phone,Status FROM Users", mycon)
            da.Fill(ds)
    ...
    Private Sub userpic()
        Try
            ...
            Dim da As New OleDbDataAdapter(("select * from Users where matric ='" & Trim(DataGridView1.CurrentRow.Cells(0).Value) & "'"), conn)
